...
function Header() {
  return /* @__PURE__ */ jsx("header", { className: "bg-[#1a3a5c] text-white shadow-lg", children: /* @__PURE__ */ jsxs("div", { className: "max-w-6xl mx-auto px-4 py-4 flex items-center justify-between", children: [
    /* @__PURE__ */ jsxs(Link, { to: "/", className: "flex items-center gap-3 group", children: [
      /* @__PURE__ */ jsx("div", { className: "w-10 h-10 rounded-full bg-[#c9962a] flex items-center justify-center text-white font-bold text-lg flex-shrink-0", children: "B" }),
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("div", { className: "font-bold text-lg leading-tight group-hover:text-[#c9962a] transition-colors", children: "Biblioteca Municipală" }),
        /* @__PURE__ */ jsx("div", { className: "text-[#c9962a] text-sm font-semibold tracking-wide", children: "Mangalia" })
      ] })
    ] }),
    ...
    /* @__PURE__ */ jsx("nav", { className: "md:hidden flex items-center gap-1", children: navLinks.map((link) => /* @__PURE__ */ jsx(
      Link,
      {
        to: link.to,
...
function Footer() {
  return /* @__PURE__ */ jsxs("footer", { className: "bg-[#1a3a5c] text-white mt-16", children: [
    /* @__PURE__ */ jsxs("div", { className: "max-w-6xl mx-auto px-4 py-10 grid grid-cols-1 md:grid-cols-3 gap-8", children: [
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 mb-3", children: [
          /* @__PURE__ */ jsx("div", { className: "w-8 h-8 rounded-full bg-[#c9962a] flex items-center justify-center font-bold text-sm", children: "B" }),
          /* @__PURE__ */ jsx("span", { className: "font-bold text-base", children: "Biblioteca Municipală Mangalia" })
        ] }),
      ...
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("h3", { className: "font-semibold text-[#c9962a] mb-3 uppercase text-xs tracking-widest", children: "Program" }),
        /* @__PURE__ */ jsx("ul", { className: "space-y-1 text-sm text-white/80", children: libraryInfo.hours.map((h) => /* @__PURE__ */ jsxs("li", { className: "flex justify-between gap-4", children: [
          /* @__PURE__ */ jsx("span", { children: h.day }),
          /* @__PURE__ */ jsx("span", { className: h.interval === "Închis" ? "text-red-300" : "text-white", children: h.interval })
        ] }, h.day)) })
      ] }),
      /* @__PURE__ */ jsxs("div", { children: [
        /* @__PURE__ */ jsx("h3", { className: "font-semibold text-[#c9962a] mb-3 uppercase text-xs tracking-widest", children: "Contact" }),
        /* @__PURE__ */ jsxs("address", { className: "not-italic text-sm text-white/80 space-y-1", children: [
          /* @__PURE__ */ jsx("p", { children: libraryInfo.address }),
          /* @__PURE__ */ jsx("p", { children: /* @__PURE__ */ jsx("a", { href: `tel:${libraryInfo.phone}`, className: "hover:text-[#c9962a] transition-colors", children: libraryInfo.phone }) }),
          /* @__PURE__ */ jsx("p", { children: /* @__PURE__ */ jsx("a", { href: `mailto:${libraryInfo.email}`, className: "hover:text-[#c9962a] transition-colors", children: libraryInfo.email }) })
        ] })
      ] })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "border-t border-white/10", children: /* @__PURE__ */ jsxs("div", { className: "max-w-6xl mx-auto px-4 py-4 flex flex-col md:flex-row items-center justify-between gap-2 text-xs text-white/50", children: [
      ...
      /* @__PURE__ */ jsxs("nav", { className: "flex gap-4", children: [
        /* @__PURE__ */ jsx(Link, { to: "/", className: "hover:text-white transition-colors", children: "Acasă" }),
        /* @__PURE__ */ jsx(Link, { to: "/collections", className: "hover:text-white transition-colors", children: "Colecții" }),
        /* @__PURE__ */ jsx(Link, { to: "/events", className: "hover:text-white transition-colors", children: "Evenimente" }),
        /* @__PURE__ */ jsx(Link, { to: "/contact", className: "hover:text-white transition-colors", children: "Contact" })
      ] })
    ] }) })
  ] });
}
...
const $$splitComponentImporter$3 = () => import("./contact-BN_Oir7l.js");
const Route$3 = createFileRoute("/contact")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./index-BDZ--Ofi.js");
const Route$2 = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./index-DrgDcXPV.js");
const Route$1 = createFileRoute("/events/")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const $$splitComponentImporter = () => import("./index-CuNuWKLs.js");
